const loadingMessages = [
  ...
  "Fetching placement stories...",
  "Organizing company experiences...",
  "Loading success stories...",
  "Preparing interview insights...",
  "Connecting to experience database...",
  "Loading community experiences...",
  "Fetching preparation tips...",
  "Setting up your experience feed...",
  "Syncing with database..."
]

const tips = [
  "Read interview experiences to understand company patterns",
  "Learn from others' mistakes and success stories",
  "Focus on companies that match your skill level",
  "Practice questions mentioned in experiences",
  "Note down common interview rounds and patterns",
