const loadingMessages = [
  ...
  "Organizing programming resources...",
  "Fetching latest materials...",
  "Preparing study content...",
  "Loading topic categories...",
  "Setting up material library...",
  "Connecting to resource database...",
  "Loading company-specific materials...",
  "Preparing download links...",
  "Syncing with database..."
]

const tips = [
  "Download materials for offline study sessions",
  "Focus on topics relevant to your target companies",
  "Practice with multiple resources for better understanding",
  "Keep track of completed topics in your study plan",
  "Share useful resources with the community",
  "Review materials regularly for better retention"
]
