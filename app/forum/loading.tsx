const loadingMessages = [
  ...
  "Organizing Q&A discussions...",
  "Loading community posts...",
  "Preparing forum content...",
  "Connecting to discussion database...",
  "Loading expert answers...",
  "Setting up AI writing assistance...",
  "Fetching popular topics...",
...
const tips = [
  ...
  "Use proper tags to categorize your questions",
  "Help others by answering questions you know",
  "Upvote helpful answers to support the community",
  "Follow up on your questions with additional details"
]
