        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground">Starting your HR interview...</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="container mx-auto px-4 py-8">
          ...
          <CardContent>
            <div className="text-center space-y-6">
              ...
              <div className="space-y-4">
                {isSpeaking && (
                  <div className="flex items-center justify-center gap-3 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div className={`w-24 h-24 rounded-full border-4 flex items-center justify-center transition-all duration-300 ${
                    isSpeaking ? 'border-purple-500 bg-purple-50 dark:bg-purple-950/20' :
                  ...
                  {(isSpeaking || isListening) && (
                    <div className={`absolute inset-0 rounded-full animate-ping ${
                      isSpeaking ? 'border-4 border-purple-400' : 'border-4 border-red-400'
                    }`}></div>
                  )}
                </div>
              </div>
        ...
        {/* Tips */}
        <Card className="mt-8 bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800">
          <CardHeader>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-purple-800 dark:text-purple-200">
              ...
              <li>• Focus on your achievements and learnings</li>
